...
# 数据集文件夹位置
filepath = r"D:\学习\大创\data\训练数据集\data\logMel 1：1"

paddy_labels = {negative: 0,
                positive: 1}


class PaddyDataSet_6(Dataset):
...
image_mean = [0.42746902, 0.6474644, 0.4993739]
image_std = [0.38065454, 0.35554656, 0.3535182]
# 读取数据集后再进行划分
data_dir = filepath
# 实例化一个对象
data_0 = PaddyDataSet_6(data_dir=data_dir,

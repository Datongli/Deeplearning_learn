...
# -------------------------------------------------- #
# 权重参数路径
weights_path = r"D:\学习\大创\data\训练数据集\model\pth\cat_vs_dog\model_cat_vs_dog_第1折验证ResNet网络.pth"
...
for img_path in os.listdir(img_dir_path):
    ...
    img_mean = [0.48832113, 0.4550773, 0.4169604]
    img_std = [0.22954218, 0.22502677, 0.2253174]
    # 预处理函数

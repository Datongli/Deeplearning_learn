...
data_dir = r"D:\学习\大创\data\训练数据集\data\Track1+CoughVid 谱图合集\Track1+CoughVid logMel(new)_2023-03-04-15-29-23"
...
data_transforms = {
    'train': transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize([0.33478397, 0.55253255, 0.5409211], [0.36969644, 0.3965568, 0.33030042])
    ]),
...
# 正弦函数形式衰减学习率
exp_lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer_ft, step_size=8, gamma=0.6)
    #
    #CosineAnnealingLR(optimizer_ft, T_max=4)
...
if __name__ == "__main__":
    ...
    plt.savefig(photo_folder + "\\" + model_name + "34验证网络_loss_" + str(nowTime) + ".jpg")
    # plt.show()
    # plt.xlim((0,50))
    # plt.ylim((0,1))
    plt.figure()
    ...
    plt.savefig(photo_folder + "\\" + model_name + "34验证网络_acc_" + str(nowTime) + ".jpg")

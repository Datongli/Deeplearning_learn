...
def slicewav(audiofilespath, audiofilespathshift):
    # 保存剪切的音频'E:/基金/fastchirplet-master/fastchirplet-master/audio/'
    # 音频文件路径，帧长时间单位，帧的重叠率
    frame_time = 4000  #帧长
    overlap_rate = 0.5   #帧移，帧的0.5倍
    ...
    with tf.io.TFRecordWriter("./train4000.tfrecords") as writer:  # tfrecords功能
        with tf.io.TFRecordWriter("./test4000.tfrecords") as writer2:
...
if __name__ == '__main__':
    data_dir = 'data_aughard\\'
    # data_dir = 'data11\\'
    data_dir2 = 'datahard2\\'
    slicewav(data_dir, data_dir2)
